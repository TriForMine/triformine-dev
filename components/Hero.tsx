			...
			<div className={classes.inner}>
				...
				<Container p={0} size={600}>
					<Text size="lg" color="dimmed" className={classes.description}>
						An independent programmer. Creator of the discord bot Isekai Maid and much more!
					</Text>
				</Container>

				<div className={classes.controls}>
					<Link href="/projects" passHref>
						<Button component="a" className={classes.control} size="lg" variant="default" color="gray">
							Projects
						</Button>
					</Link>
					<Link href="https://github.com/triformine" passHref>
						<Button component="a" target="_blank" className={classes.control} size="lg">
							Github
						</Button>
					</Link>
				</div>
